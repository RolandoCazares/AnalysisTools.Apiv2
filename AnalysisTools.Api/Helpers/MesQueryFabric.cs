...
namespace analysistools.api.Helpers
{
    ...
    public static class MesQueryFabric
    {
        ...
        public static string QueryForProducedAndFilteredFPY(string Producto, DateTime FromDate, DateTime ToDate)
        {
            ...
            SELECT
  TO_CHAR(MAX(AL1.RUN_DATE), 'YYYY-MM-DD') AS fecha,
  AL3.PDK_MATERIAL AS MATERIAL, 
  AL5.BMT_NAME AS NAME, 
  AL4.PRP_VAR AS VAR, 
  AL1.RUNID_TYPE AS IDTYPE, 
  COUNT(*) AS CONTADOR
...
GROUP BY TO_CHAR(AL1.RUN_DATE, 'YYYY-MM-DD'), AL3.PDK_MATERIAL, AL5.BMT_NAME, AL4.PRP_VAR, AL1.RUNID_TYPE;
